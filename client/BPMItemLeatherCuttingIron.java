...
public class BPMItemLeatherCuttingIron extends FCItemCraftingProgressive
{
	
	static int internalBladeDamage;
	
	public BPMItemLeatherCuttingIron(int iItemID) {
		super(iItemID);
	 ...
	 {
	    	ItemStack leatherWorking = new ItemStack( BPMDefinitions.leatherCuttingIron, 1);
