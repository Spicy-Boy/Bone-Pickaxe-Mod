...
public class BPMItemRibCuttingIron extends FCItemCraftingProgressive 
{
static int internalBladeDamage;
	
	public BPMItemRibCuttingIron(int iItemID) {
		super(iItemID);
	 ...
	 {
	    	ItemStack leatherWorking = new ItemStack( BPMDefinitions.ribCuttingIron, 1);
	        ...
	        {
	        	FCUtilsItem.GivePlayerStackOrEject( player, new ItemStack(BPMDefinitions.ironKnife, 1, internalBladeDamage));
	        	FCUtilsItem.GivePlayerStackOrEject( player, new ItemStack(Item.beefRaw, 1));
	        }
	        
	        
			
	        return new ItemStack( BPMDefinitions.rib, 1);
	 }
