...
public class FCBetterThanWolves extends FCAddOn
{
	...
	private void InstantiateModBlocks()
	{
	    ...
	    fcBlockCandlePlain = new FCBlockCandle(parseID("fcBlockCandlePlainID"), 16, "fcBlockCandle");
	    ...
	    for (int i = 0; i < 16; i++) {
	    	...
	    	fcBlockCandlesColored[i] = new FCBlockCandle(parseID(idProperty), i, "fcBlockCandle" + FCUtilsColor.colorOrderCapital[i]);
	    }
	...
	private void InstantiateModItems()
	{
		...
		fcItemCandleLegacy = new FCItemCandle(parseID("fcItemCandleID"));
