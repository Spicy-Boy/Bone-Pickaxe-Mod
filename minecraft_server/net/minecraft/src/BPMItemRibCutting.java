...
public class BPMItemRibCutting extends FCItemCraftingProgressive 
{
	
	static int internalBladeDamage;
	
	public BPMItemRibCutting(int iItemID) {
		super(iItemID);
	 ...
	 {
	    	ItemStack ribCarving = new ItemStack( BPMDefinitions.ribCutting, 1);
	        ...
	        {
	        	FCUtilsItem.GivePlayerStackOrEject( player, new ItemStack(BPMDefinitions.flintKnife, 1, internalBladeDamage));
