...
public class Block
{
	...
	public static Block bed = (new FCBlockBed(26)).setHardness(1F).SetBuoyant().setUnlocalizedName("bed").disableStats();
	...
	public static Block stairsCobblestone = new FCBlockStairsCobblestone( 67 , 0);
	...
	public static Block stairsStoneBrick = new FCBlockStairsStoneBrick( 109, 0);
	...
	public static BlockComparator redstoneComparatorActive = (BlockComparator)(new FCBlockComparator(150, true)).setHardness(0.0F).setStepSound(soundWoodFootstep).setUnlocalizedName("comparator").disableStats();
	...
	static
	{
		...
		Item.itemsList[stoneBrick.blockID] = (new ItemMultiTextureTile(stoneBrick.blockID - 256, stoneBrick, FCBlockStoneBrick.STONE_BRICK_TYPES_STRATIFIED)).setUnlocalizedName("stonebricksmooth");
		...
		Item.itemsList[sapling.blockID] = (new ItemMultiTextureTile(sapling.blockID - 256, sapling, FCBlockSaplingLegacy.SAPLING_TYPES)).setUnlocalizedName("sapling");
