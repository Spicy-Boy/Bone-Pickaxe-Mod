...
public class WorldClient extends World
{
    ...
    //AARON changed the method below to solve the damp firework crash
...
//    }
    public void func_92088_a(double par1, double par3, double par5, double par7, double par9, double par11, NBTTagCompound par13NBTTagCompound)
    {
        ...
        this.mc.effectRenderer.addEffect((EntityFX) EntityList.createEntityOfType(EntityFireworkStarterFX.class, this, par1, par3, par5, par7, par9, par11, this.mc.effectRenderer));
    }
}
