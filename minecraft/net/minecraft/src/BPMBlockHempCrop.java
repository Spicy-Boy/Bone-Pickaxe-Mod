...
public class BPMBlockHempCrop extends BlockCrops
{
    ...
    protected BPMBlockHempCrop( int iBlockID )
    {
        super( iBlockID );
...
//        		!(player.getCurrentEquippedItem().getItem() instanceof FCItemShears))
        	if ( player.getCurrentEquippedItem() == null || !getValidTool(player.getCurrentEquippedItem()))
        	{
