...
public class EntityFireworkStarterFX extends EntityFX
{
    ...
    //AARON backported this fix from future CE to prevent a damp firework crash
    public EntityFireworkStarterFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, EffectRenderer par14EffectRenderer)
    {
        this(par1World, par2, par4, par6, par8, par10, par12, par14EffectRenderer, null);
    }
