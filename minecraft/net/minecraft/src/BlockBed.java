...
//                        	ChunkCoordinates var14 = var21.playerLocation;
                ...
                else
                {
                    ...
                    //AARON imported this from SBTW 2.0: Hardcore Soaked feature!
    ...
    public static ChunkCoordinates getNearestEmptyChunkCoordinates(World par0World, int par1, int par2, int par3, int par4)
    {
        ...
        for (int var7 = 0; var7 <= 1; ++var7)
        {
            ...
            for (int var12 = var8; var12 <= var10; ++var12)
            {
                ...
                {
                	//AARON stole this neat little fix so that players cant wake up outside a corner and die
                    if ((var12 == var8 || var12 == var10) && (var13 == var9 || var13 == var11) ) {
